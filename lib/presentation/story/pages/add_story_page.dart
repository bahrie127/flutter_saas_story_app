...
class _AddStoryPageState extends State<AddStoryPage> {
  ...
  void _submit() {
    if (_formKey.currentState?.validate() ?? false) {
      if (_selectedImage == null) {
        context.showError('Pilih gambar terlebih dahulu');
        return;
      }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocListener<CreateStoryBloc, CreateStoryState>(
        listener: (context, state) {
          state.maybeWhen(
            success: (story) {
              context.showSuccess('Cerita berhasil ditambahkan!');
              context.pop(true);
            },
            error: (message) {
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                // Submit Button
                BlocBuilder<CreateStoryBloc, CreateStoryState>(
